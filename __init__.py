"""The Odum - ElprisetJustNu integration."""
...
from .elprisetjustnu_client import (
    setup_client,
    LoginRequired,
)
...
from .const import VAL_CURRENT_PRICE, VAL_DAY_AVERAGE_PRICE
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Odum - ElprisetJustNu from a config entry."""
